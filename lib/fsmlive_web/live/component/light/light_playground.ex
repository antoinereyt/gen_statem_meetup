  ...
  def render(assigns) do
    ...
    <div class="flex flex-col">
      ...
      <div class="flex justify-center bg-blue-300 p-2">
        <button phx-click="on" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-4">
          on
        </button>
        <button phx-click="off" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
          off
        </button>
      </div>
    </div>
